...
<body class="min-h-full bg-gradient-to-b from-gray-600 to-gray-700 antialiased relative" x-data="{modal:''}">
    ...
    <div class="bg-slate-800">
        @if ($disableEdit)
            <x-page.announcement>
                <strong class="font-semibold">Sadu již nelze editovat</strong>, <span class="text-white">byl vyplněný min. jeden příklad. <br />V případě potřeby si <a href="{{ Route::localizedUrl('kit.create') }}" target="_blank" class="underline hover:no-underline">vytvořte novou sadu</a>.</span>
            </x-page.announcement>
        @endif

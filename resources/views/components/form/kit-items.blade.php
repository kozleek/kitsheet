...
<div class="space-y-4">
    ...
    <x-form.section label="Nastavení">
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <x-form.checkbox label="Výběr výsledků" description="Výběr z existujících výsledků, stejně jako v tiskové verzi." name="settingsExamplesSelectionOfResults" value="{{ $kit ? in_array('selectionOfResults', $kit->settings_examples) : 'false' }}" />
        </div>
    </x-form.section>

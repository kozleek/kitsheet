<x-page.card>
    <div class="space-y-4">
        ...
        <x-form.section label="Nastavení">
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <x-form.checkbox label="Priority operátorů" description="Do příkladů se přidají závorky pro dvojice čísel." name="settingsExamplesWithParentheses" />
            </div>
        </x-form.section>
    </div>
    ...
    <div class="mt-8 flex items-center gap-4">
        ...
        @if ($mode == 'edit')
            <x-button icon="heroicon-o-plus" x-on:click="modal='modal-kit-update'" primary="true" disabled="{{ $canSave == false }}">
                Uložit sadu
            </x-button>
